...
ฑฑบ Programa ณ UFSFIN05 บ Autor ณ TOTVS Protheus     บ Data ณ  06/01/2012 บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UFSFIN06( cEmpAmb, cFilAmb )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  06/01/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSXB บ Autor ณ TOTVS Protheus     บ Data ณ  06/01/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Consulta de Agencias'													, ; //XB_DESCRI
	'Consulta de Agencias'													, ; //XB_DESCSPA
	'Consulta de Agencias'													, ; //XB_DESCENG
	'SA6'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_COLUNA
	'Codigo'																, ; //XB_DESCRI
	'Codigo + Nบ Agencia'													, ; //XB_DESCSPA
	'Code + Office No. +'													, ; //XB_DESCENG
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Nro Agencia'															, ; //XB_DESCRI
	'Nบ Agencia'															, ; //XB_DESCSPA
	'Office No.'															, ; //XB_DESCENG
...
aAdd( aSXB, { ;
	...
	'03'																	, ; //XB_COLUNA
	'Nro Conta'																, ; //XB_DESCRI
	'Nบ Cuenta'																, ; //XB_DESCSPA
	'C.Account No'															, ; //XB_DESCENG
	'A6_NUMCON'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'04'																	, ; //XB_COLUNA
	'Nome Red.Bco'															, ; //XB_DESCRI
	'Nom.ReducBco'															, ; //XB_DESCSPA
	'Short Name'															, ; //XB_DESCENG
	'A6_NREDUZ'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Consulta de Conta Co'													, ; //XB_DESCRI
	'Consulta de Conta Co'													, ; //XB_DESCSPA
	'Consulta de Conta Co'													, ; //XB_DESCENG
	'SA6'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	''																		, ; //XB_DESCSPA
	''																		, ; //XB_DESCENG
	'SA6->A6_COD == MV_PAR03 .And.SA6->A6_AGENCIA == MV_PAR04'				} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'CONSULTA BORDERO'														, ; //XB_DESCRI
	'CONSULTA BORDERO'														, ; //XB_DESCSPA
	'CONSULTA BORDERO'														, ; //XB_DESCENG
	'SE1'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'12'																	, ; //XB_COLUNA
	'Num. Bordero + Dt Em'													, ; //XB_DESCRI
	'Num.bordero + Fch Em'													, ; //XB_DESCSPA
	'Bordero Nr. + Issue'													, ; //XB_DESCENG
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'Prefijo'																, ; //XB_DESCSPA
	'Prefix'																, ; //XB_DESCENG
	'E1_NUMBOR+" - "+E1_PREFIXO+" - "+E1_NUM'								} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	''																		, ; //XB_DESCSPA
	''																		, ; //XB_DESCENG
	'!Empty(SE1->E1_NUMBOR) .And. SE1->E1_FILIAL >= MV_PAR01 .And. SE1->E1_FILIAL <= MV_PAR02'} ) //XB_CONTEM
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  06/01/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
