...
ฑฑบ Programa ณ UPCOMP   บ Autor ณ TOTVS Protheus     บ Data ณ  10/04/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPCOMP     - Gerado por EXPORDIC / Upd. V.4.10.4 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPCOMP( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPCOMP" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPCOMP" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  10/04/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  10/04/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX2, { ;
	...
	'Solicita็๕es de Compra'												, ; //X2_NOME
...
aAdd( aSX2, { ;
	...
	'REGISTROS DE OCORRENCIAS'												, ; //X2_NOME
	'REGISTROS DE OCORRENCIAS'												, ; //X2_NOMESPA
	'REGISTROS DE OCORRENCIAS'												, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX2, { ;
	...
	'OCORRENCIAS'															, ; //X2_NOME
	'OCORRENCIAS'															, ; //X2_NOMESPA
	'OCORRENCIAS'															, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  10/04/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Marca Produt'															, ; //X3_TITULO
	'Marca Produt'															, ; //X3_TITSPA
	'Marca Produt'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	80																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Obs. Ad Prod'															, ; //X3_TITULO
	'Obs. Ad Prod'															, ; //X3_TITSPA
	'Obs. Ad Prod'															, ; //X3_TITENG
	'Obs. Adicionais  Produto'												, ; //X3_DESCRIC
	'Obs. Adicionais  Produto'												, ; //X3_DESCSPA
	'Obs. Adicionais  Produto'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Filial Fatur'															, ; //X3_TITULO
	'Filial Fatur'															, ; //X3_TITSPA
	'Filial Fatur'															, ; //X3_TITENG
	'Filial para faturar'													, ; //X3_DESCRIC
	'Filial para faturar'													, ; //X3_DESCSPA
	'Filial para faturar'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Equipamento Parado;2=Manutencao Corretiva;3=Manutencao Preventiva;4=Compra para Estoque', ; //X3_CBOX
	'1=Equipamento Parado;2=Manutencao Corretiva;3=Manutencao Preventiva;4=Compra para Estoque', ; //X3_CBOXSPA
	'1=Equipamento Parado;2=Manutencao Corretiva;3=Manutencao Preventiva;4=Compra para Estoque', ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Original'																, ; //X3_TITSPA
	'Original'																, ; //X3_TITENG
	'Original (S=Sim,N=Nao)'												, ; //X3_DESCRIC
...
aAdd( aSX3, { ;
	...
	'Aplicacao'																, ; //X3_TITSPA
	'Aplicacao'																, ; //X3_TITENG
	'Aplicacao'																, ; //X3_DESCRIC
	'Aplicacao'																, ; //X3_DESCSPA
	'Aplicacao'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cot. Enviada'															, ; //X3_TITULO
	'Cot. Enviada'															, ; //X3_TITSPA
	'Cot. Enviada'															, ; //X3_TITENG
	'Cotacao Enviada S/N'													, ; //X3_DESCRIC
	'Cotacao Enviada S/N'													, ; //X3_DESCSPA
	'Cotacao Enviada S/N'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Marca Produt'															, ; //X3_TITSPA
	'Marca Produt'															, ; //X3_TITENG
	'Marca Produtos'														, ; //X3_DESCRIC
	'Marca Produtos'														, ; //X3_DESCSPA
	'Marca Produtos'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Original'																, ; //X3_TITENG
	'Original (S=Sim,N=Nao)'												, ; //X3_DESCRIC
	'Original (S=Sim,N=Nao)'												, ; //X3_DESCSPA
	'Original (S=Sim,N=Nao)'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Filial Entre'															, ; //X3_TITULO
	'Filial Entre'															, ; //X3_TITSPA
	'Filial Entre'															, ; //X3_TITENG
	'Filial para Entrega'													, ; //X3_DESCRIC
	'Filial para Entrega'													, ; //X3_DESCSPA
	'Filial para Entrega'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Data Entrege'															, ; //X3_TITULO
	'Data Entrege'															, ; //X3_TITSPA
	'Data Entrege'															, ; //X3_TITENG
	'Data Entrege'															, ; //X3_DESCRIC
	'Data Entrege'															, ; //X3_DESCSPA
	'Data Entrege'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Qtd Inicial'															, ; //X3_TITULO
	'Qtd Inicial'															, ; //X3_TITSPA
	'Qtd Inicial'															, ; //X3_TITENG
	'Quantidade Inicial'													, ; //X3_DESCRIC
	'Quantidade Inicial'													, ; //X3_DESCSPA
	'Quantidade Inicial'													, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	40																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'E-mail Forne'															, ; //X3_TITULO
	'E-mail Forne'															, ; //X3_TITSPA
	'E-mail Forne'															, ; //X3_TITENG
	'E-mail Fornecedor'														, ; //X3_DESCRIC
	'E-mail Fornecedor'														, ; //X3_DESCSPA
	'E-mail Fornecedor'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Total do Desconto'														, ; //X3_DESCRIC
	'Total do Desconto'														, ; //X3_DESCSPA
	'Total do Desconto'														, ; //X3_DESCENG
	'@E 999,999,999.99'														, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'No Solicitac'															, ; //X3_TITULO
	'No Solicitac'															, ; //X3_TITSPA
	'No Solicitac'															, ; //X3_TITENG
	'Numero Solicitacao'													, ; //X3_DESCRIC
	'Numero Solicitacao'													, ; //X3_DESCSPA
	'Numero Solicitacao'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'No Cotacao'															, ; //X3_TITULO
	'No Cotacao'															, ; //X3_TITSPA
	'No Cotacao'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hora Ocorren'															, ; //X3_TITULO
	'Hora Ocorren'															, ; //X3_TITSPA
	'Hora Ocorren'															, ; //X3_TITENG
	'Hora Ocorrencia'														, ; //X3_DESCRIC
	'Hora Ocorrencia'														, ; //X3_DESCSPA
	'Hora Ocorrencia'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Data Ocorren'															, ; //X3_TITULO
	'Data Ocorren'															, ; //X3_TITSPA
	'Data Ocorren'															, ; //X3_TITENG
	'Data Ocorrencia'														, ; //X3_DESCRIC
	'Data Ocorrencia'														, ; //X3_DESCSPA
	'Data Ocorrencia'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'E-Mail II'																, ; //X3_TITSPA
	'E-Mail II'																, ; //X3_TITENG
	'E-Mail II'																, ; //X3_DESCRIC
	'E-Mail II'																, ; //X3_DESCSPA
	'E-Mail II'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'E-Mail III'															, ; //X3_TITULO
	'E-Mail III'															, ; //X3_TITSPA
	'E-Mail III'															, ; //X3_TITENG
	'E-Mail III'															, ; //X3_DESCRIC
	'E-Mail III'															, ; //X3_DESCSPA
	'E-Mail III'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'E-Mail IV'																, ; //X3_TITSPA
	'E-Mail IV'																, ; //X3_TITENG
	'E-Mail IV'																, ; //X3_DESCRIC
	'E-Mail IV'																, ; //X3_DESCSPA
	'E-Mail IV'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	0																		, ; //X3_DECIMAL
	'Z2_NUMERO'																, ; //X3_TITULO
	'Numero Seq'															, ; //X3_TITSPA
	'Numero Seq'															, ; //X3_TITENG
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'GETSXENUM("SZ2","Z2_NUMERO")'											, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Desc Ocorren'															, ; //X3_TITULO
	'Desc Ocorren'															, ; //X3_TITSPA
	'Desc Ocorren'															, ; //X3_TITENG
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  10/04/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	...
	'1'																		, ; //ORDEM
	'Z2_NUMERO'																, ; //CHAVE
	'Numero Sequencial'														, ; //DESCRICAO
	'Numero Sequencial'														, ; //DESCSPA
	'Numero Sequencial'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ2'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'Z2_FILIAL+Z2_NUMSC+Z2_PRODUTO'											, ; //CHAVE
	'No Solicitac+Cod Produto'												, ; //DESCRICAO
	'No Solicitac+Cod Produto'												, ; //DESCSPA
	'No Solicitac+Cod Produto'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ2'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'Z2_NUMCOT+Z2_PRODUTO'													, ; //CHAVE
	'No Cotacao+No Cotacao+Cod Produto'										, ; //DESCRICAO
	'No Cotacao+No Cotacao+Cod Produto'										, ; //DESCSPA
	'No Cotacao+No Cotacao+Cod Produto'										, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  10/04/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
