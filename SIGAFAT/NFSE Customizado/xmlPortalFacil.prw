...
user function xmlPortalFacil(cRPS, cOperacao)
	local cXml := ""
	Local cError   := ""
	Local cWarning := ""
...
static function Enviar(cRPS) // monta RPS
	...
	cXml +=     Iif(SM0->M0_CODMUN == '3136702', '<EnviarLoteRpsSincronoEnvio xmlns="http://nfejf.portalfacil.com.br/nfseserv/schema/nfse_v202.xsd" >','<EnviarLoteRpsSincronoEnvio xmlns="http://nfsesetelagoas.portalfacil.com.br/nfseserv/schema/nfse_v202.xsd">' )
	//cXml += '<EnviarLoteRpsSincronoEnvio xmlns="http://nfejf.portalfacil.com.br/nfseserv/schema/nfse_v202.xsd" >
	cXml += '	<LoteRps Id="L'+cRPS+'" versao="2.02">'
