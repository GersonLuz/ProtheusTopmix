...
ฑฑบ Programa ณ UFSPON01 บ Autor ณ TOTVS Protheus     บ Data ณ  14/10/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UFSPON01   - Gerado por EXPORDIC / Upd. V.4.9.4 EFS        ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UFSPON01()
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		Else
			MsgStop( "Atualiza็ใo nใo Realizada.", "UFSPON01" )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  14/10/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  14/10/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
// Tabela SPB
//
aAdd( aSX3, {'SPB','26','PB_ZORIG','C',10,0,'Origem','Origem','Origem','Origem do Registro','Origem do Registro','Origem do Registro','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128),'','',0,	Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','',''} )
//
// Tabela SRV
//
aAdd( aSX3, {'SRV','60','RV_ZCSCOMP','C',1,0,'Cons. Verba','Cons. Verba','Cons. Verba','Considera Verba','Considera Verba','Considera Verba','@!','Pertence("SN") .And. u_FSVldPrc(2)',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'"N"','',1,	Chr(254) + Chr(192),'','','U','S','A','R','','','S=SIM;N=NAO','S=SIM;N=NAO','S=SIM;N=NAO','','','','','0',''} )
aAdd( aSX3, {'SRV','61','RV_ZORPREC','C',3,0,'Precedencia','Precedencia','Precedencia','Ordem de Precedencia','Ordem de Precedencia','Ordem de Precedencia','@!','u_FSVldPrc(1)',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',1,	Chr(254) + Chr(192),'','','U','S','A','R','','','','','','','','','','0',''} )
//
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  14/10/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
// Tabela SRV
//
aAdd( aSIX, {'SRV','8','RV_FILIAL+RV_ZCSCOMP+RV_ZORPREC','Cons. Verba+Precedencia','Cons. Verba+Precedencia','Cons. Verba+Precedencia','U','','FSINDSRV','N'} )
//
// Atualizando dicionแrio
//
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSXB บ Autor ณ TOTVS Protheus     บ Data ณ  14/10/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
// Consulta SPB
//
aAdd( aSXB, {'SPB','1','01','DB','Resultados do Period','Resultados do Period','Resultados do Period','SPB'} )
aAdd( aSXB, {'SPB','2','01','01','Matricula + Codigo V','Matricula + Concepto','Registration + Allow',''} )
aAdd( aSXB, {'SPB','4','01','01','Filial','Sucursal','Branch','PB_FILIAL'} )
aAdd( aSXB, {'SPB','4','01','02','Dt. Pagto.','Fecha Pago','Payment Day','PB_DATA'} )
aAdd( aSXB, {'SPB','5','01','','','','','SPB->PB_DATA'} )
aAdd( aSXB, {'SPB','6','01','','','','','UniqueKey({"PB_FILIAL","PB_DATA"})'} )
//
// Atualizando dicionแrio
//
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  14/10/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aHlpPor, 'Nome da Rotina customizada.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PPB_ZORIG  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "PB_ZORIG  " + CRLF
...
aHlpPor := {}
aAdd( aHlpPor, '[exclusivo Cliente TopMix]' )
aAdd( aHlpPor, 'O usuแrio irแ informar se a verba serแ' )
aAdd( aHlpPor, 'considerada no Cแlculo de Compensa็ใo' )
aAdd( aHlpPor, 'Sim ou Nใo.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PRV_ZCSCOMP", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "RV_ZCSCOMP" + CRLF

aHlpPor := {}
aAdd( aHlpPor, '[exclusivo Cliente TopMix]' )
aAdd( aHlpPor, 'O usuแrio irแ informar a ordem de' )
aAdd( aHlpPor, 'preced๊ncia que serแ utilizada no' )
aAdd( aHlpPor, 'cแlculo customizado.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PRV_ZORPREC", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "RV_ZORPREC" + CRLF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  14/10/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
